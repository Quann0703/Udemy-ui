...
export const GoogleIcon = ({ width = '3rem', height = '3rem', classNames }) => {
    return (
        <svg
            width={width}
            height={height}
...
export const FacebookIcon = ({ width = '3rem', height = '100%', classNames }) => {
    return (
        <svg
            height={height}
            widths={width}
...
export const GithubIcon = ({ width = '3rem', height = '512px', classNames }) => {
    return (
        <svg
            height={height}
            widths={width}
